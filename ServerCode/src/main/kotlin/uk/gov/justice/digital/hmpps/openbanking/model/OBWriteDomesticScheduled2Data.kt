...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteDomesticScheduled2DataInitiation
 ...
 * @param initiation 
 */
data class OBWriteDomesticScheduled2Data(
    ...
    @get:JsonProperty("Initiation", required = true) val initiation: OBWriteDomesticScheduled2DataInitiation
) {
