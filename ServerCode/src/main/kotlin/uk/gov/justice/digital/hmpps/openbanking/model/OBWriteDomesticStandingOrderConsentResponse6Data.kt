...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteDomesticStandingOrderConsentResponse6DataInitiation
 ...
 * @param status Specifies the status of consent resource in code form. For a full list of values see `OBInternalConsentStatus1Code` in *ISO_External_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)
 ...
 * @param debtor 
 */
data class OBWriteDomesticStandingOrderConsentResponse6Data(
    ...
    @Schema(example = "null", required = true, description = "Specifies the status of consent resource in code form. For a full list of values see `OBInternalConsentStatus1Code` in *ISO_External_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)")
    @get:JsonProperty("Status", required = true) val status: OBWriteDomesticStandingOrderConsentResponse6Data.Status,
    ...
    @get:JsonProperty("Permission", required = true) val permission: OBWriteDomesticStandingOrderConsentResponse6Data.Permission,

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Initiation", required = true) val initiation: OBWriteDomesticStandingOrderConsentResponse6DataInitiation,
    ...
    @get:JsonProperty("ReadRefundAccount") val readRefundAccount: OBWriteDomesticStandingOrderConsentResponse6Data.ReadRefundAccount? = null,
