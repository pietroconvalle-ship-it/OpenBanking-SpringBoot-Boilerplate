...
import org.openapitools.model.OBWriteDomesticScheduledConsent4
import org.openapitools.model.OBWriteDomesticScheduledConsentResponse5
...
class DomesticScheduledPaymentConsentsApiController() {
    ...
    @Operation(
        ...
        description = """""",
        responses = [
            ApiResponse(responseCode = "201", description = "Domestic Scheduled Payment Consents Created", content = [Content(schema = Schema(implementation = OBWriteDomesticScheduledConsentResponse5::class))]),
    ...
    @Operation(
        ...
        description = """""",
        responses = [
            ApiResponse(responseCode = "200", description = "Domestic Scheduled Payment Consents Read", content = [Content(schema = Schema(implementation = OBWriteDomesticScheduledConsentResponse5::class))]),
            ApiResponse(responseCode = "400", description = "Bad request", content = [Content(schema = Schema(implementation = OBErrorResponse11::class))]),
            ApiResponse(responseCode = "401", description = "Unauthorized"),
            ApiResponse(responseCode = "403", description = "Forbidden", content = [Content(schema = Schema(implementation = OBErrorResponse11::class))]),
            ApiResponse(responseCode = "404", description = "Not found"),
