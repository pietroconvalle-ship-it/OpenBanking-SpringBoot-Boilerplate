...
import org.openapitools.model.OBReferredDocumentInformation
import org.openapitools.model.OBRemittanceInformationStructuredCreditorReferenceInformation
 ...
 * @param invoicee dentification of the party to whom an invoice is issued, when it is different from the debtor or ultimate debtor.
 ...
 */
data class OBRemittanceInformationStructured(

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("ReferredDocumentInformation") val referredDocumentInformation: kotlin.collections.List<OBReferredDocumentInformation>? = null,
    ...
    @get:Size(min=1,max=256)
    @Schema(example = "80200112344562", description = "dentification of the party to whom an invoice is issued, when it is different from the debtor or ultimate debtor.")
