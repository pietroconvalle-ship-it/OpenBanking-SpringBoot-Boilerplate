...
import org.openapitools.model.ExternalCategoryPurpose1Code2
import org.openapitools.model.OBExternalPurpose1Code1
import org.openapitools.model.OBInternalExtendedAccountType1Code1
 ...
 * @param paymentContextCode Specifies the payment context, for a full list of values refer to `OBInternalPaymentContext1Code` in *OB_Internal_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets) 
...
data class OBRisk11(
    ...
    @Schema(example = "null", description = "Specifies the payment context, for a full list of values refer to `OBInternalPaymentContext1Code` in *OB_Internal_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets) ")
    @get:JsonProperty("PaymentContextCode") val paymentContextCode: OBRisk11.PaymentContextCode? = null,
    ...
    @get:JsonProperty("PaymentPurposeCode") val paymentPurposeCode: OBExternalPurpose1Code1? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("CategoryPurposeCode") val categoryPurposeCode: ExternalCategoryPurpose1Code2? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("BeneficiaryAccountType") val beneficiaryAccountType: OBInternalExtendedAccountType1Code1? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("DeliveryAddress") val deliveryAddress: OBPostalAddress72? = null
) {
