...
import org.openapitools.model.OBBranchAndFinancialInstitutionIdentification60
import org.openapitools.model.OBCashAccount50
import org.openapitools.model.OBInternalBeneficiaryType1Code
 ...
 * @param creditorAgent 
 */
data class OBBeneficiary5Detail(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("CreditorAccount", required = true) val creditorAccount: OBCashAccount50,
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("CreditorAgent") val creditorAgent: OBBranchAndFinancialInstitutionIdentification60? = null
) {
