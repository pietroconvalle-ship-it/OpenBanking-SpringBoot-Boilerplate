...
import org.openapitools.model.OBWriteDomesticStandingOrder3DataInitiation
 ...
 */
data class OBWriteDomesticStandingOrderConsent5Data(
    ...
    @get:JsonProperty("Permission", required = true) val permission: OBWriteDomesticStandingOrderConsent5Data.Permission,
    ...
    @get:JsonProperty("ReadRefundAccount") val readRefundAccount: OBWriteDomesticStandingOrderConsent5Data.ReadRefundAccount? = null,
