...
import org.openapitools.model.OBStatement2StatementAmountInner
...
data class OBStatement2(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("StatementAmount") val statementAmount: kotlin.collections.List<OBStatement2StatementAmountInner>? = null,
