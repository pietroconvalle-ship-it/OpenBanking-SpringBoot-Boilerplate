...
import org.openapitools.model.OBProxy1
 ...
 * @param identification Beneficiary account identification.
...
data class OBCashAccount51(
    ...
    @Schema(example = "null", required = true, description = "Beneficiary account identification.")
