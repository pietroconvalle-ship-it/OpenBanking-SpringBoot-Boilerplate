...
import org.openapitools.model.ExternalCreditorReferenceType1Code
 ...
 */
data class OBRemittanceInformationStructuredCreditorReferenceInformation(

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("Code") val code: ExternalCreditorReferenceType1Code? = null,
