...
import org.openapitools.model.OBWriteInternationalConsentResponse6DataExchangeRateInformation
import org.openapitools.model.OBWriteInternationalResponse5DataRefund
...
/**
 * 
 * @param internationalPaymentId OB: Unique identification as assigned by the ASPSP to uniquely identify the international payment resource.
 ...
 * @param status Specifies the status of the payment information group.
 ...
 * @param debtor 
 */
data class OBWriteInternationalResponse5Data(

    @get:Size(min=1,max=40)
    @Schema(example = "null", required = true, description = "OB: Unique identification as assigned by the ASPSP to uniquely identify the international payment resource.")
    @get:JsonProperty("InternationalPaymentId", required = true) val internationalPaymentId: kotlin.String,
    ...
    @Schema(example = "null", required = true, description = "Specifies the status of the payment information group.")
    @get:JsonProperty("Status", required = true) val status: OBWriteInternationalResponse5Data.Status,
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("Refund") val refund: OBWriteInternationalResponse5DataRefund? = null,
