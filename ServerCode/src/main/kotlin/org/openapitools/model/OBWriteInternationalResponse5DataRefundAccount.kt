 ...
 * @param proxy 
 */
data class OBWriteInternationalResponse5DataRefundAccount(
    ...
    @Schema(example = "null", required = true, description = "Name of the account, as assigned by the account servicing institution. Usage: The account name is the name or names of the account owner(s) represented at an account level. The account name is not the product name or the nickname of the account. OB: ASPSPs may carry out name validation for Confirmation of Payee, but it is not mandatory.")
