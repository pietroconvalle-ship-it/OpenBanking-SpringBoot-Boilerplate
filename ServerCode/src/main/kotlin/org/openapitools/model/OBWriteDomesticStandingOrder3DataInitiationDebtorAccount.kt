...
import org.openapitools.model.OBProxy11
 ...
 * @param proxy 
 */
data class OBWriteDomesticStandingOrder3DataInitiationDebtorAccount(
    ...
    @Schema(example = "null", description = "The account name is the name or names of the account owner(s) represented at an account level, as displayed by the ASPSP's online channels. Note, the account name is not the product name or the nickname of the account.")
