...
import org.openapitools.model.ExternalProxyAccountType1Code1
 ...
 */
data class OBProxy11(

    @get:Size(min=1,max=2048)
    @Schema(example = "null", required = true, description = "Identification used to indicate the account identification under another specified name.")
    @get:JsonProperty("Identification", required = true) val identification: kotlin.String,

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Code", required = true) val code: ExternalProxyAccountType1Code1,
