...
import org.openapitools.model.OBWriteInternationalScheduled3DataInitiation
 ...
 * @param debtor 
 */
data class OBWriteInternationalScheduledConsentResponse6Data(
    ...
    @get:JsonProperty("Status", required = true) val status: OBWriteInternationalScheduledConsentResponse6Data.Status,
    ...
    @get:JsonProperty("Permission", required = true) val permission: OBWriteInternationalScheduledConsentResponse6Data.Permission,
    ...
    @get:JsonProperty("ReadRefundAccount") val readRefundAccount: OBWriteInternationalScheduledConsentResponse6Data.ReadRefundAccount? = null,
