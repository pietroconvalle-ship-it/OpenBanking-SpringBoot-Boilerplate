 ...
 */
data class OBBranchAndFinancialInstitutionIdentification602(
    ...
    @Schema(example = "null", description = "Unique and unambiguous identification of the servicing institution.")
