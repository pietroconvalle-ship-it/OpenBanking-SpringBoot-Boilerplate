 ...
 * @param debtor 
 */
data class OBWriteDomesticScheduledConsentResponse5Data(
    ...
    @get:JsonProperty("Status", required = true) val status: OBWriteDomesticScheduledConsentResponse5Data.Status,
    ...
    @get:JsonProperty("Permission", required = true) val permission: OBWriteDomesticScheduledConsentResponse5Data.Permission,
    ...
    @get:JsonProperty("ReadRefundAccount") val readRefundAccount: OBWriteDomesticScheduledConsentResponse5Data.ReadRefundAccount? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Status {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBWriteDomesticScheduledConsentResponse5Data'")
            }
        }
    }
