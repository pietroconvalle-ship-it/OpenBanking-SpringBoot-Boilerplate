...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadBalance1Data
 ...
 * @param meta 
 */
data class OBReadBalance1(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBReadBalance1Data,
