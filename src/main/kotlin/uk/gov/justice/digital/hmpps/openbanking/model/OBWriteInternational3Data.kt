...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteInternational3DataInitiation
 ...
 * @param initiation 
 */
data class OBWriteInternational3Data(
    ...
    @get:JsonProperty("Initiation", required = true) val initiation: OBWriteInternational3DataInitiation
) {
