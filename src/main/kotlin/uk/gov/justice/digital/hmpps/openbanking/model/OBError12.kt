...
/**
 *
 * @param errorCode Low level textual error code, for all enum values see `ExternalReturnReason1Code` [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)
 ...
 */
data class OBError12(

  @get:Size(min = 4, max = 4)
  @Schema(example = "U001", required = true, description = "Low level textual error code, for all enum values see `ExternalReturnReason1Code` [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)")
