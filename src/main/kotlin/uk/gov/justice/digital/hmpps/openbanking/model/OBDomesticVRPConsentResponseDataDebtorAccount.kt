...
import uk.gov.justice.digital.hmpps.openbanking.model.OBProxy13
 ...
 * @param proxy
 */
data class OBDomesticVRPConsentResponseDataDebtorAccount(
  ...
  @get:JsonProperty("Proxy") val proxy: OBProxy13? = null,
)
