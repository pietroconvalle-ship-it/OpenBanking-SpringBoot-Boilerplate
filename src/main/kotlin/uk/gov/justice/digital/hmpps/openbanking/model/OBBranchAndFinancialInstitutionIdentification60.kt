 ...
 */
data class OBBranchAndFinancialInstitutionIdentification60(
  ...
  @Schema(example = "80200112344562", description = "Unique and unambiguous identification of the servicing institution.")
