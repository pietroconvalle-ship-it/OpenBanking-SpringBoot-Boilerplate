...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteInternationalConsentResponse6Data
 ...
 * @param meta
 */
data class OBWriteInternationalConsentResponse6(

  @field:Valid
  @Schema(example = "null", required = true, description = "")
  @get:JsonProperty("Data", required = true) val `data`: OBWriteInternationalConsentResponse6Data,
