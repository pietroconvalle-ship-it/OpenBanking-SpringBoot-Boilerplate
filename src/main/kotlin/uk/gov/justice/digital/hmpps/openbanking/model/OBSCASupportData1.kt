...
data class OBSCASupportData1(
  ...
  enum class RequestedSCAExemptionType(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
      @JvmStatic
      @JsonCreator
      fun forValue(value: kotlin.String): RequestedSCAExemptionType = values().firstOrNull { it -> it.value == value }
  ...
  enum class AppliedAuthenticationApproach(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
      @JvmStatic
      @JsonCreator
      fun forValue(value: kotlin.String): AppliedAuthenticationApproach = values().firstOrNull { it -> it.value == value }
        ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBSCASupportData1'")
    }
  }
}
