...
data class OBWriteInternationalConsentResponse6DataExchangeRateInformation(
  ...
  enum class RateType(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
      @JvmStatic
      @JsonCreator
      fun forValue(value: kotlin.String): RateType = values().firstOrNull { it -> it.value == value }
        ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBWriteInternationalConsentResponse6DataExchangeRateInformation'")
    }
  }
}
