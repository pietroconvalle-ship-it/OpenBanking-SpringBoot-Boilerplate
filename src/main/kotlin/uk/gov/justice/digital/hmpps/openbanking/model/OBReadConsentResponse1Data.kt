...
data class OBReadConsentResponse1Data(
  ...
  enum class Status(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
      ...
      fun forValue(value: kotlin.String): Status = values().firstOrNull { it -> it.value == value }
        ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBReadConsentResponse1Data'")
    }
  }
  ...
  enum class Permissions(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
      @JvmStatic
      @JsonCreator
      fun forValue(value: kotlin.String): Permissions = values().firstOrNull { it -> it.value == value }
        ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBReadConsentResponse1Data'")
    }
  }
}
