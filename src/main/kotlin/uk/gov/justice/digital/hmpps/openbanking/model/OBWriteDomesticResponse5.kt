...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteDomesticResponse5Data
 ...
 * @param meta 
 */
data class OBWriteDomesticResponse5(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBWriteDomesticResponse5Data,
