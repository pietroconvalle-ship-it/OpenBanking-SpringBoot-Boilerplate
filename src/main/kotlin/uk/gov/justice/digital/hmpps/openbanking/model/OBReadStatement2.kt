...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadDataStatement2
 ...
 * @param meta 
 */
data class OBReadStatement2(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBReadDataStatement2,
