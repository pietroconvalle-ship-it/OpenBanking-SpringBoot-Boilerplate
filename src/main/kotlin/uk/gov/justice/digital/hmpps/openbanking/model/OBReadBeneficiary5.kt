...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadBeneficiary5Data
 ...
 * @param meta 
 */
data class OBReadBeneficiary5(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBReadBeneficiary5Data,
