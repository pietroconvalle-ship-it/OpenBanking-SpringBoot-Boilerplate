...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteDomestic2DataInitiationCreditorAccount
...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteInternational3DataInitiationCreditor
 ...
 */
data class OBWriteInternational3DataInitiation(
    ...
    @get:JsonProperty("InstructionPriority") val instructionPriority: OBWriteInternational3DataInitiation.InstructionPriority? = null,
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("Creditor") val creditor: OBWriteInternational3DataInitiationCreditor? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): InstructionPriority {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBWriteInternational3DataInitiation'")
            }
        }
    }
