...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteInternationalStandingOrderConsentResponse7Data
 ...
 * @param meta 
 */
data class OBWriteInternationalStandingOrderConsentResponse7(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBWriteInternationalStandingOrderConsentResponse7Data,
