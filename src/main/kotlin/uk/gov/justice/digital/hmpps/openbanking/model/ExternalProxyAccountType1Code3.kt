...
*/
enum class ExternalProxyAccountType1Code3(@get:JsonValue val value: kotlin.String) {
  ...
  companion object {
    @JvmStatic
    @JsonCreator
    fun forValue(value: kotlin.String): ExternalProxyAccountType1Code3 = values().firstOrNull { it -> it.value == value }
      ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ExternalProxyAccountType1Code3'")
  }
}
