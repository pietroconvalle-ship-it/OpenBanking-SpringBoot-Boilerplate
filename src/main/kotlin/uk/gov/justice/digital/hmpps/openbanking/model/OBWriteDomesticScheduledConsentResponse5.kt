...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteDomesticScheduledConsentResponse5Data
 ...
 * @param meta
 */
data class OBWriteDomesticScheduledConsentResponse5(

  @field:Valid
  @Schema(example = "null", required = true, description = "")
  @get:JsonProperty("Data", required = true) val `data`: OBWriteDomesticScheduledConsentResponse5Data,
