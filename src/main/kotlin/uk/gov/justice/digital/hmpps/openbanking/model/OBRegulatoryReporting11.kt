...
import uk.gov.justice.digital.hmpps.openbanking.model.OBRegulatoryAuthority21
import uk.gov.justice.digital.hmpps.openbanking.model.OBStructuredRegulatoryReporting31
    ...
    */
    enum class DebitCreditReportingIndicator(@get:JsonValue val value: kotlin.String) {
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): DebitCreditReportingIndicator {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBRegulatoryReporting11'")
            }
        }
    }
