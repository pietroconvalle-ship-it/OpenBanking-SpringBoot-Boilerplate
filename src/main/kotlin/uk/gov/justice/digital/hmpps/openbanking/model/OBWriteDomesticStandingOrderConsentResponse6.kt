...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteDomesticStandingOrderConsentResponse6Data
 ...
 * @param meta
 */
data class OBWriteDomesticStandingOrderConsentResponse6(

  @field:Valid
  @Schema(example = "null", required = true, description = "")
  @get:JsonProperty("Data", required = true) val `data`: OBWriteDomesticStandingOrderConsentResponse6Data,
