...
import uk.gov.justice.digital.hmpps.openbanking.model.OBRemittanceInformationStructured1
 ...
 */
data class OBRemittanceInformation21(

  @field:Valid
  @Schema(example = "null", description = "")
  @get:JsonProperty("Structured") val structured: kotlin.collections.List<OBRemittanceInformationStructured1>? = null,
