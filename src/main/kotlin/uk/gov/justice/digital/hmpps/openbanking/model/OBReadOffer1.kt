...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadOffer1Data
 ...
 * @param meta 
 */
data class OBReadOffer1(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBReadOffer1Data,
