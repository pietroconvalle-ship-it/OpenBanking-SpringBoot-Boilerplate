...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteInternationalStandingOrderResponse7DataRefund

/**
 *
 * @param internationalStandingOrderId OB: Unique identification as assigned by the ASPSP to uniquely identify the international standing order resource.
 ...
 * @param status Specifies the status of resource in code form. For a list of values see `ExternalPaymentTransactionStatus1Code` in *OB_Internal_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)
 ...
 * @param debtor
 */
data class OBWriteInternationalStandingOrderResponse7Data(

  @get:Size(min = 1, max = 40)
  @Schema(example = "null", required = true, description = "OB: Unique identification as assigned by the ASPSP to uniquely identify the international standing order resource.")
  @get:JsonProperty("InternationalStandingOrderId", required = true) val internationalStandingOrderId: kotlin.String,
  ...
  @Schema(example = "null", required = true, description = "Specifies the status of resource in code form. For a list of values see `ExternalPaymentTransactionStatus1Code` in *OB_Internal_CodeSet* [here](https://github.com/OpenBankingUK/External_Internal_CodeSets)")
  @get:JsonProperty("Status", required = true) val status: OBWriteInternationalStandingOrderResponse7Data.Status,
  ...
  @field:Valid
  @Schema(example = "null", description = "")
  @get:JsonProperty("Refund") val refund: OBWriteInternationalStandingOrderResponse7DataRefund? = null,
  ...
  enum class Status(@get:JsonValue val value: kotlin.String) {
    ...
    companion object {
      ...
      fun forValue(value: kotlin.String): Status = values().firstOrNull { it -> it.value == value }
        ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OBWriteInternationalStandingOrderResponse7Data'")
    }
  }
}
