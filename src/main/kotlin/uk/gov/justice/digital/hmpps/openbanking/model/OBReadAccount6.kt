...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadAccount6Data
 ...
 * @param meta 
 */
data class OBReadAccount6(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBReadAccount6Data,
