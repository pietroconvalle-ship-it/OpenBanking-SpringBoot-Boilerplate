...
import uk.gov.justice.digital.hmpps.openbanking.model.OverdraftTierBandSetInner1
 ...
 */
data class Overdraft1(

    @field:Valid
    @get:Size(min=1)
    @Schema(example = "null", required = true, description = "Tier band set details")
    @get:JsonProperty("OverdraftTierBandSet", required = true) val overdraftTierBandSet: kotlin.collections.List<OverdraftTierBandSetInner1>,
