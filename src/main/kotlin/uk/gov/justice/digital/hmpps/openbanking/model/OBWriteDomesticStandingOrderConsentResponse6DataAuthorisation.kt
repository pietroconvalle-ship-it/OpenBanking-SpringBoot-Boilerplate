 ...
 * @param authorisationType Type of authorisation flow requested.
 ...
 */
data class OBWriteDomesticStandingOrderConsentResponse6DataAuthorisation(

    @Schema(example = "null", required = true, description = "Type of authorisation flow requested.")
    @get:JsonProperty("AuthorisationType", required = true) val authorisationType: OBWriteDomesticStandingOrderConsentResponse6DataAuthorisation.AuthorisationType,
