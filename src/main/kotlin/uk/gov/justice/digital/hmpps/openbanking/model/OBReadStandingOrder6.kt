...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadStandingOrder6Data
 ...
 * @param meta 
 */
data class OBReadStandingOrder6(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBReadStandingOrder6Data,
