...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteFileConsentResponse4Data
 ...
 * @param meta
 */
data class OBWriteFileConsentResponse4(

  @field:Valid
  @Schema(example = "null", required = true, description = "")
  @get:JsonProperty("Data", required = true) val `data`: OBWriteFileConsentResponse4Data,
