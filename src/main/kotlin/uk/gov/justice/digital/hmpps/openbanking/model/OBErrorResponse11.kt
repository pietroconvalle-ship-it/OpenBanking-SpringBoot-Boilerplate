...
import uk.gov.justice.digital.hmpps.openbanking.model.OBError11
 ...
 */
data class OBErrorResponse11(

    @field:Valid
    @get:Size(min=1)
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Errors", required = true) val errors: kotlin.collections.List<OBError11>,
