...
class FundsConfirmationsApiController {
  ...
  @Operation(
    ...
    description = """""",
    responses = [
      ApiResponse(responseCode = "201", description = "Funds Confirmation Created", content = [Content(schema = Schema(implementation = OBFundsConfirmationResponse1::class))]),
