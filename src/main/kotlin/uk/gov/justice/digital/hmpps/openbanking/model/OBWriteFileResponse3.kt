...
import uk.gov.justice.digital.hmpps.openbanking.model.OBWriteFileResponse3Data
 ...
 * @param meta
 */
data class OBWriteFileResponse3(

  @field:Valid
  @Schema(example = "null", required = true, description = "")
  @get:JsonProperty("Data", required = true) val `data`: OBWriteFileResponse3Data,
