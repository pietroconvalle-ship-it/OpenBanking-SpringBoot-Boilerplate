...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadScheduledPayment3Data
 ...
 * @param meta
 */
data class OBReadScheduledPayment3(

  @field:Valid
  @Schema(example = "null", required = true, description = "")
  @get:JsonProperty("Data", required = true) val `data`: OBReadScheduledPayment3Data,
