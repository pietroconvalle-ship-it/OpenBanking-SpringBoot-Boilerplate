...
import uk.gov.justice.digital.hmpps.openbanking.model.OBAccount6AccountInner
import uk.gov.justice.digital.hmpps.openbanking.model.OBBranchAndFinancialInstitutionIdentification50
...
import uk.gov.justice.digital.hmpps.openbanking.model.StatementFrequencyAndFormatInner
...
data class OBAccount6(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("Account") val account: kotlin.collections.List<OBAccount6AccountInner>? = null,
