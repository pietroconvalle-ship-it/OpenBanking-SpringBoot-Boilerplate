...
import uk.gov.justice.digital.hmpps.openbanking.model.OBReadDirectDebit2Data
 ...
 * @param meta 
 */
data class OBReadDirectDebit2(

    @field:Valid
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("Data", required = true) val `data`: OBReadDirectDebit2Data,
